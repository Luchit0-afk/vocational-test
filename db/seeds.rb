...
# Questions
Q1 = Question.create(name: 'Q1',
                     description: 'Me trasladaría a una zona agrícola - ganadera para ejercer mi profesión.', number: 1, type: 'Multiple-Choice')
Q2 = Question.create(name: 'Q2',
                     description: 'Tengo buena memoria y no me cuesta estudiar y retener fórmulas y palabras técnicas.', number: 2, type: 'Multiple-Choice')
Q3 = Question.create(name: 'Q3',
                     description: 'Me gusta escribir. En general mis trabajos son largos y están bien organizados.', number: 3, type: 'Multiple-Choice')
Q4 = Question.create(name: 'Q4', description: 'Sé quien es Steven Hawking: Conozco y me atraen sus descubrimientos.',
                     number: 4, type: 'Multiple-Choice')
Q5 = Question.create(name: 'Q5',
                     description: 'Me actualizo respecto de los avances tecnológicos y me intereso por investigar y conocer', number: 5, type: 'Multiple-Choice')
Q6 = Question.create(name: 'Q6',
                     description: 'Sé quien es Andy Warhol y a qué movimiento artístico pertenece. Me apasiona conocer acerca del arte y sus exponentes.', number: 6, type: 'Multiple-Choice')
Q7 = Question.create(name: 'Q7',
                     description: 'En general me intereso por las dificultades que ha tenido que atravesar la humanidad y cómo lo ha superado.', number: 7, type: 'Multiple-Choice')
Q8 = Question.create(name: 'Q8',
                     description: 'Me apasiona leer y no me importa si el libro que elijo tiene muchas páginas, para mí es un gran entretenimiento.', number: 8, type: 'Multiple-Choice')
Q9 = Question.create(name: 'Q9',
                     description: 'Me atrae conocer los procesos y las áreas que hacen funcionar a las empresas.', number: 9, type: 'Multiple-Choice')
Q10 = Question.create(name: 'Q10',
                      description: 'Me siento identificado con el pensamiento de algunos filósofos y escritores.', number: 10, type: 'Multiple-Choice')
Q11 = Question.create(name: 'Q11',
                      description: 'Me encanta estudiar el cuerpo humano y conocer cómo funciona. Además, no me impresiona la sangre.', number: 11, type: 'Multiple-Choice')
Q12 = Question.create(name: 'Q12',
                      description: 'Si pudiera elegir, pasaría mucho tiempo diseñando novedosos objetos o edificios en mi computadora.', number: 12, type: 'Multiple-Choice')
Q13 = Question.create(name: 'Q13', description: 'Si mi blog fuera temático, trataría acerca de:', number: 13,
                      type: 'Multiple-Choice')
Q14 = Question.create(name: 'Q14',
                      description: 'Integraría un equipo de trabajo encargado de producir un audiovisual sobre:', number: 14, type: 'Multiple-Choice')
Q15 = Question.create(name: 'Q15', description: 'Sería importante destacarme como:', number: 15,
                      type: 'Multiple-Choice')
...
C1Q13 = Choice.create(
  text: 'La importancia de la expresión artística en el desarrollo de la identidad de los pueblos', question: Q13
)
C2Q13 = Choice.create(
  text: 'La arquelogía urbana como forma de aprender acerca de la historia cultural de una ciudad.', question: Q13
)
C3Q13 = Choice.create(
  text: 'La tecnología satelital en un proyecto para descubrir actividad volcánica para prevenir catástrofes climáticas.', question: Q13
)
C4Q13 = Choice.create(text: 'Ninguna de las opciones.', question: Q13)

C1Q14 = Choice.create(text: 'La práctica de deportes y su influencia positiva en el estado de ánimo de las personas.',
                      question: Q14)
C2Q14 = Choice.create(text: 'Los pensadores del siglo XX y su aporte a la gestión de las organizaciones.',
                      question: Q14)
C3Q14 = Choice.create(text: 'Las mascotas y su incidencia en la calidad de vida de las personas no videntes.',
                      question: Q14)
C4Q14 = Choice.create(text: 'El uso de la PC como herramienta para el control de los procesos industriales.',
                      question: Q14)
...
C5Q15 = Choice.create(text: 'Un agente de prensa audaz, número uno en el ranking de notas a celebridades.',
                      question: Q15)
